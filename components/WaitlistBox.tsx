...
export default function WaitlistBox({ onDismiss, onJoinWaitlist }: WaitlistProps) {
    return (
        <div className="fixed bottom-0 left-0 z-10">
            <div className="bg-white dark:bg-gray-900 p-4 pt-10 sm:p-8 text-sm mb-8 ml-3 mr-3 text-left shadow-xl relative rounded-md border border-mySecondary/50 dark:border-gray-700">
