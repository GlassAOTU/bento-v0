        ...
        >
            ...
            <div className="flex flex-col items-center justify-center text-center px-4 max-w-2xl">
                ...
                <button
                    ...
                    className="px-8 py-4 bg-white dark:bg-darkInput text-black dark:text-white rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors font-semibold text-lg"
                >
                    Create an Account
                </button>
            </div>
