    ...
    return (
        <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-50">
            <div className="bg-white p-8 rounded-lg shadow-lg w-[90%] max-w-md">
                ...
                <button onClick={onClose} className="text-right float-right border rounded-full p-1"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className=""><path d="M18 6 6 18" /><path d="m6 6 12 12" /></svg></button>
                ...
                <form action="https://submit-form.com/akdxwKQgR" target="_blank" className="flex flex-col gap-6">
                    ...
                    <button formTarget="" className="w-full bg-mySecondary text-white p-2 rounded-lg">Submit</button>
                </form>
