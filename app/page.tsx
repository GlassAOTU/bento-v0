  ...
  return (
    <div className="min-h-screen bg-[#fffcf8] text-[#4a4023] pb-16">
      ...
      <div className="w-full relative">
        <Image
          src="/images/anime-characters.png"
        ...
        <div className="absolute bottom-12 left-6 md:left-10">
          <h1 className="text-5xl md:text-6xl font-bold text-[#4a4023]">bento</h1>
          <p className="text-sm md:text-base text-[#4a4023]">
            a new way to anime
            <br />
            arrives summer 2025
          </p>
      ...
      <div className="max-w-3xl mx-auto px-6 mt-8">
        ...
        <div className="mt-8">
          <div className="flex justify-between items-center mb-4">
            <p className="text-[#4a4023]">Tags (Choose upto 5)</p>
